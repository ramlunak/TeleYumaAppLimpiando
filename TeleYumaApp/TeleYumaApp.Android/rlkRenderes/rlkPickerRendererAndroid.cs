...
[assembly: ExportRenderer(typeof(picker), typeof(rlkPickerRendererAndroid))]
namespace TeleYumaApp.Droid.rlkRenderes
{
    public class rlkPickerRendererAndroid : PickerRenderer
    {
        picker element;

        public rlkPickerRendererAndroid(Android.Content.Context context) : base(context)
        {
        }
